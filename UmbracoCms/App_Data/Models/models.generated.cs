...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "4d836819c13edffd")]
...
#pragma warning restore 0109
	...
	/// <summary>Dealer Locator</summary>
	[PublishedContentModel("dealerLocator")]
	public partial class DealerLocator : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "dealerLocator";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public DealerLocator(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<DealerLocator, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
